        ...
        rx.vstack(
            ...
            rx.grid(
                    ...
                    rx.foreach(
                        ...
                        lambda a: rx.hstack(
                            rx.icon(
                                "bell",
                                size=16,
                                color=rx.cond(a["leida"], "gray", "var(--orange-9)"),
                            ),
                            ...
                            rx.cond(
                                ...
                                rx.button(
                                    ...
                                    variant="ghost",
                                    size="1",
                                    on_click=lambda: DashboardState.marcar_alerta_leida(
                                        a["id"]
                                    ),
                                ),
                                rx.box(),
                ...
                rx.vstack(
                    ...
                    _quick_access_card("Productos", "/productos", "package", "blue"),
                    _quick_access_card(
                    ...
                    _quick_access_card(
                        "Producción diaria", "/produccion-diaria", "factory", "orange"
                    ),
                    _quick_access_card("Reportes", "/reportes", "file-text", "gray"),
                    spacing="3",
                    width="100%",
                ),
                columns="2",
