    ...
    return rx.hstack(
        rx.vstack(
            ...
            rx.select.root(
                ...
                value=lote["producto_id"].to_string()
                if lote.get("producto_id")
                else rx.Var.create(""),
                    ...
                    rx.dialog.content(
                        ...
                        rx.vstack(
                            rx.hstack(
                                rx.vstack(
                                    rx.text(
                                        "Tipo de entrada *", size="2", weight="medium"
                                    ),
                                    rx.select.root(
                    ...
                    rx.dialog.content(
                        ...
                        rx.cond(
                            ...
                            rx.vstack(
                                ...
                                rx.heading("Lotes", size="4"),
                                rx.foreach(
                                    EntradaSalidaState.detalle_entrada["lotes"],
                                    lambda l: rx.hstack(
                                        rx.text(
                                            "Producto #" + l["producto_id"].to_string(),
                                            size="2",
                                        ),
