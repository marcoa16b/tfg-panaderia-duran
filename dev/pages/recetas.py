    ...
    return rx.hstack(
        rx.vstack(
            ...
            rx.select.root(
                ...
                value=ing["producto_id"].to_string()
                    ...
                    rx.dialog.content(
                        ...
                        rx.cond(
                            ...
                            rx.vstack(
                                ...
                                rx.heading("Ingredientes", size="4"),
                                rx.foreach(
                                    RecetaState.detalle_receta["ingredientes"],
                                    lambda d: rx.hstack(
                                        rx.text(
                                            "Producto #" + d["producto_id"].to_string(),
                                            size="2",
                                        ),
                ...
                rx.dialog.root(
                    rx.dialog.content(
                        ...
                        rx.vstack(
                            rx.hstack(
                                rx.text(
                                    "Cantidad a producir:", size="2", weight="medium"
                                ),
                                rx.input(
                                    type="number",
