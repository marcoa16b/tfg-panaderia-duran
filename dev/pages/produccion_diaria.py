                ...
                rx.table.root(
                    ...
                    rx.table.body(
                        rx.cond(
                            ...
                            rx.foreach(ProduccionState.producciones, _produccion_row),
                            rx.table.row(
                                rx.table.cell(
                                    rx.text(
                            ...
                            rx.vstack(
                                ...
                                rx.foreach(
                                    ...
                                    lambda i: rx.hstack(
                                        ...
                                        rx.badge(i["cantidad"], color_scheme="blue"),
                                        spacing="3",
                                        width="100%",
                                        padding_y="0.15em",
                                    ),
                ...
                rx.dialog.content(
                    ...
                    rx.cond(
                        ...
                        rx.vstack(
                            ...
                            rx.foreach(
                                ProduccionState.verificacion_detalle,
                                lambda d: rx.hstack(
                                    ...
                                    rx.badge(
                                        rx.cond(
                                            d["suficiente"],
                                            rx.text("OK", size="1"),
                                            rx.text("Falta: ", d["faltante"], size="1"),
                                        ),
                                        color_scheme=rx.cond(
                    ...
                    rx.cond(
                        ...
                        rx.vstack(
                            rx.hstack(
                                ...
                                rx.text(
                                    ProduccionState.detalle_produccion["receta_nombre"],
                                    size="2",
                                ),
                                spacing="3",
                            ),
